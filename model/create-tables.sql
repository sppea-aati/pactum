...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "PACTUM"."VW_PESSOAL" ("MATRICULA", "NOME", "CPF", "EMAIL1", "EMAIL2", "CARGO_CODIGO", "CARGO_DESCRICAO", "DDD_RESIDENCIAL", "TELEFONE_RESIDENCIAL", "DDD_COMERCIAL", "TELEFONE_COMERCIAL", "DDD_CELULAR", "TELEFONE_CELULAR", "LOTACAO_CODIGO", "LOTACAO_SIGLA", "LOTACAO_DESCRICAO", "LOTACAO_SIGLA_PR", "LOTACAO_UF", "DESLIGADO", "DT_NASCIMENTO", "TITULO_NR", "RG_NUMERO", "RG_ORGEMISSOR_SG", "RG_UF_SG") AS 
  SELECT a.matricula, a.nome, cpf_num_to_string(a.cpf), a.email_tabralho email1,
       ...
       a.cargo cargo_codigo,
       a.cargo_ds cargo_descricao,
       a.endereco_ddd ddd_residencial,
       a.endereco_fone telefone_residencial, a.endereco_ddd ddd_comercial,
       a.endfuncional_fone telefone_comercial,
       a.endereco_celular_ddd ddd_celular,
       a.endereco_celular_nr telefone_celular,
       a.lotacao_exe_cd lotacao_codigo, a.lotacao_exe_sigla lotacao_sigla,
       a.lotacao_exe_ds lotacao_descricao,
       a.lotacao_oficial_sigla lotacao_sigla_pr, a.lotacao_exe_uf lotacao_uf,
       a.st_exonerado_ou_desligado desligado,
       a.dt_nascimento dt_nascimento,
       a.TITULO_NR titulo_nr,
       a.RG_NUMERO RG_NUMERO,
       a.RG_ORGEMISSOR_SG RG_ORGEMISSOR_SG,
       a.RG_UF_SG RG_UF_SG
  FROM mpu.gps_tab_cadastro a;
;
